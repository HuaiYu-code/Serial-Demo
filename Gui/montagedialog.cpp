...
#if HHT_CHINA
    ui->titleLabel->setText(QStringLiteral("Newline 助手"));
    ui->activeButton->setText(QStringLiteral("激活Newline 助手"));
    ui->installButton->setText(QStringLiteral("安装Montage"));
    ui->cancelButton->setText(QStringLiteral("取消"));
    ui->plainTextEdit->setPlainText(QStringLiteral("激活Montage失败，请手动添加到Newline 助手。\n如果没有安装,请先安装。"));
#else
