...
RollingLable::RollingLable(QWidget *parent) : QLabel(parent)
{
    fontSize    = 0;
    left        = 0;
    timerId     = 0;
...
void RollingLable::upateLabelRollingState()
{
...
void RollingLable::timerEvent(QTimerEvent *e)
{
...
void RollingLable::paintEvent(QPaintEvent *e)
{
    QPainter p(this);
...
void RollingLable::setText(const QString & txt)
{
    QLabel::setText(txt);
...
void RollingLable::resizeEvent(QResizeEvent *e)
{
